[![Latest version](https://img.shields.io/static/v1?label=Version&message=1.7.22&color=yellowgreen)](https://github.com/jakob-bagterp/browserist/releases/latest)
...
[![Downloads](https://api.pepy.tech/personalized-badge/browserist?period=total&units=international_system&left_color=grey&right_color=blue&left_text=Downloads)](https://pepy.tech/project/browserist)
