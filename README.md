[![Latest version](https://img.shields.io/static/v1?label=version&message=0.14.0&color=yellowgreen)](https://github.com/jakob-bagterp/browserist/releases/latest)
...
Define a general timeout in seconds for each function and strategy:
