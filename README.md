[![Latest version](https://img.shields.io/static/v1?label=version&message=0.7.0&color=yellowgreen)](https://github.com/jakob-bagterp/browserist/releases/latest)
...
* Supports type hints and other capabilites of Python 3.10 that makes development more efficient
