...
def until_condition_is_true(func: Callable[[object, Union[str, List[object]]], bool], timeout: int = timeout.DEFAULT, wait_interval_seconds: float = interval.DEFAULT) -> None:
    i = 0
    retries = timeout / wait_interval_seconds
