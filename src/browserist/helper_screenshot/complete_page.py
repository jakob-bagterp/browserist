...
async def default(browser_driver: BrowserDriver, destination_file_path: str, destination_dir: str, delay_seconds: float) -> None:
    def get_screenshot_of_visible_portion_and_scroll_down(browser_driver: BrowserDriver, handler: ScreenshotTempDataHandler, delay_seconds: float) -> None:
    ...
    get_screenshot_of_visible_portion_and_scroll_down(browser_driver, handler, delay_seconds)
    ...
    await task_merge_temp_files_into_final_screenshot
