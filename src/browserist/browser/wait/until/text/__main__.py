...
class WaitUntilTextDriverMethods(DriverMethods):
    ...
    def changes(self, xpath: str, baseline_text: str, timeout: float | None = None) -> None:
        ...
        Args:
            ...
            baseline_text (str): Baseline text to compare the new text to.
            timeout (float | None, optional): In seconds. Timeout to wait for text to change. If `None`, the global timeout setting is used (default 5 seconds).
        """
    ...
    def contains(self, xpath: str, regex: str, timeout: float | None = None) -> None:
        """Wait until the text of an element has changed and contains a specified text fragment, e.g. after a form action.

        Args:
            xpath (str): XPath of the text element.
            regex (str): The comparison can contain both a text fragment or a regular expression. Case insensitive.
            timeout (float | None, optional): In seconds. Timeout to wait for the text element to contain the fragment. If `None`, the global timeout setting is used (default 5 seconds).
        """
    ...
    def equals(self, xpath: str, regex: str, timeout: float | None = None) -> None:
        ...
        Args:
            xpath (str): XPath of the text element.
            regex (str): Regular expression to compare the text element to. Case sensitive and is evaluated as an exact match.
            timeout (float | None, optional): In seconds. Timeout to wait for the text element to match the condition. If `None`, the global timeout setting is used (default 5 seconds).
        """
