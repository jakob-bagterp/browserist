...
def wait_until_text_changes(driver: object, xpath: str, baseline_text: str, timeout: int) -> None:
    def has_text_changed(driver: object, baseline_text: str) -> bool:
        return get_text(driver, xpath, constant.timeout.BYPASS) != baseline_text
