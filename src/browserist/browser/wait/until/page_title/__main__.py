...
class WaitUntilPageTitleDriverMethods(DriverMethods):
    ...
    def changes(self, baseline_text: str, timeout: float = timeout.DEFAULT) -> None:
    ...
    def contains(self, page_title_fragment: str, timeout: float = timeout.DEFAULT) -> None:
    ...
    def equals(self, page_title: str, timeout: float = timeout.DEFAULT) -> None:
