...
class GetUrlDriverMethods(DriverMethods):
    ...
    def from_image(self, xpath: str, timeout: float = timeout.DEFAULT) -> str:
    ...
    def from_images(self, xpath: str, timeout: float = timeout.DEFAULT) -> list[str]:
    ...
    def from_link(self, xpath: str, timeout: float = timeout.DEFAULT) -> str:
    ...
    def from_links(self, xpath: str, timeout: float = timeout.DEFAULT) -> list[str]:
