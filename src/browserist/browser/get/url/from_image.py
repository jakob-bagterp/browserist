...
def get_url_from_image(driver: object, xpath: str, timeout: float = timeout.DEFAULT) -> str:
    ...
    return helper.retry.get_text(driver, xpath, get_src_attribute_of_element)
