...
def get_url_from_image(browser_driver: BrowserDriver, xpath: str, timeout: int) -> str:
    ...
    return helper.retry.get_text(browser_driver, xpath, get_src_attribute_of_element)
