...
class WindowHandleDriverMethods(DriverMethods):
    ...
    def all(self, selenium: bool = False) -> list[str]:  # type: ignore
        ...
        if self._timeout_should_continue():
            return get_all_window_handles(self._browser_driver.webdriver, self._controller, selenium)
    ...
    def count(self, selenium: bool = False) -> int:  # type: ignore
        ...
        if self._timeout_should_continue():
            return count_window_handles(self._browser_driver.webdriver, self._controller, selenium)
    ...
    def current(self) -> str:  # type: ignore
        ...
        if self._timeout_should_continue():
            return get_current_window_handle(self._browser_driver.webdriver)
