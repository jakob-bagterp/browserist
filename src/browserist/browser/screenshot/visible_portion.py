...
def get_screenshot_of_visible_portion(
    browser_driver: BrowserDriver, file_name: str | None = None, destination_dir: str | Path | None = None
) -> None:
    if file_name is not None:
        file_name = FilePNG(file_name)
    file_name = helper_screenshot.controller.mediate_file_name(
        browser_driver, file_name, ScreenshotType.VISIBLE_PORTION
    )
