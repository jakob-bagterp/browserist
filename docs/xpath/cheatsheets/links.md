...
description: Learn how to use powerful XPath methods to target nodes the contain specific links or URLs. Includes code examples for beginners and advanced users.
tags:
    - Tutorial
    - Cheatsheet
    - XPath
