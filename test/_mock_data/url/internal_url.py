...
CHECKBOXES: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/checkboxes.html")
...
DOWNLOAD: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/download/page.html")

DROPDOWN_SELECTOR: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/drop-down_selector.html")

LOG_IN_1_STEP: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/log_in/1_step/login_form.html")
...
MINI_SITE_DIR: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/mini_site")

MINI_SITE_ABOUT: str = update_path_format_if_windows(f"{MINI_SITE_DIR}/about.html")

MINI_SITE_CONTACT: str = update_path_format_if_windows(f"{MINI_SITE_DIR}/contact.html")

MINI_SITE_FEATURE_1: str = update_path_format_if_windows(f"{MINI_SITE_DIR}/feature_1.html")

MINI_SITE_FEATURE_2: str = update_path_format_if_windows(f"{MINI_SITE_DIR}/feature_2.html")

MINI_SITE_FEATURE_3: str = update_path_format_if_windows(f"{MINI_SITE_DIR}/feature_3.html")

MINI_SITE_HOMEPAGE: str = update_path_format_if_windows(f"{MINI_SITE_DIR}/homepage.html")

MINI_SITE_ASSETS_DIR: str = update_path_format_if_windows(f"{MINI_SITE_DIR}/assets")
...
NO_BODY: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/no_body.html")

NOT_SCROLLABLE: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/scroll/not_scrollable.html")

RADIO_BUTTONS: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/radio_buttons.html")

SEARCH: str = update_path_format_if_windows(f"file://{_web_mock_data_directory}/search/search_form.html")
