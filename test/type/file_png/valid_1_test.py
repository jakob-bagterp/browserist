...
@pytest.mark.parametrize("file_name, expectation, is_valid_expectation", [
    (VALID_PNG_FILE_NAME, does_not_raise(), True),
    (INVALID_PNG_FILE_NAME, pytest.raises(FilePNGSyntaxError), False),
])
