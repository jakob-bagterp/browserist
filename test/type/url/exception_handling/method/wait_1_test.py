...
def test_xpath_exception_handling_for_wait_for_url_changes_methods(browser_default_headless: Browser) -> None:
...
def test_xpath_exception_handling_for_wait_for_url_is_method(browser_default_headless: Browser) -> None:
