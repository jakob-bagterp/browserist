...
@pytest.mark.parametrize("xpath1, xpath2, xpath3, xpath4, xpath5, expectation", [
...
def test_xpath_exception_handling_of_login_form_2_steps(xpath1: str, xpath2: str, xpath3: str, xpath4: str, xpath5: str, expectation: Any) -> None:
    with expectation:
        _ = LoginForm2Steps(
