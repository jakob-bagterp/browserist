...
SKIP_TIMING_PERFORMANCE_TESTS = "Test skipped in GitHub Actions as it evaluates timing and/or network performance indirectly, and so likely fails on GitHub Actions. Only run on a local machine."
