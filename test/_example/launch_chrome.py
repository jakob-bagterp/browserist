...
print("is_element_displayed", browser.check_if.is_element_displayed(xpath))
...
print("is_url_valid", browser.tool.is_url_valid(browser.get.url.current()))
print("is_input_valid", browser.tool.is_input_valid(xpath, xpath + "test"))
