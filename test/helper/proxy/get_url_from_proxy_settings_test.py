...
VALID_PROXY_SETTINGS_HTTP = ProxySettings(ip="255.255.255.255", port=8080, type=ProxyProtocol.HTTP)
...
@pytest.mark.parametrize(
    "proxy_settings, add_protocol, add_port, expected",
    [
...
def test_helper_get_url_from_proxy_settings(
    proxy_settings: ProxySettings, add_protocol: bool, add_port: bool, expected: str
) -> None:
