import pytest
from _mock_data.window_handles import (WINDOW_HANDLE_1_ID, WINDOW_HANDLE_2_ID, WINDOW_HANDLE_3_ID, WINDOW_HANDLE_4_ID,
                                       WINDOW_HANDLE_5_ID, WINDOW_HANDLE_6_ID)
