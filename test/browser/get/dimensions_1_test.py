...
@pytest.mark.parametrize("url, xpath, expected_width, expected_height", [
    (internal_url.MINI_SITE_HOMEPAGE, "//section[@class='hero hero__background-image__office-ideas-on-board']", 1008, 400),
...
def test_get_dimensions(url: str, xpath: str, expected_width: int, expected_height: int, browser_default_headless_fixed_viewport: Browser) -> None:
