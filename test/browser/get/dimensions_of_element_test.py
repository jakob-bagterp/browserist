...
def test_get_dimensions_of_element(url: str, xpath: str, expected_width: int, expected_height: int, browser_default_headless: Browser) -> None:
    browser = browser_default_headless
    browser.open.url(url)
    assert expected_width, expected_height == browser.get.dimensions_of_element(xpath)
