...
@pytest.mark.parametrize("url1, url2, ignore_trailing_slash, expected_url", [
    ...
    (internal_url.MINI_SITE_HOMEPAGE, MINI_SITE_HOMEPAGE_WITH_TRAILING_SLASH, True, internal_url.MINI_SITE_HOMEPAGE),
    (internal_url.MINI_SITE_HOMEPAGE, MINI_SITE_HOMEPAGE_WITH_TRAILING_SLASH, False, MINI_SITE_HOMEPAGE_WITH_TRAILING_SLASH),
])
def test_open_url_if_not_current_ignore_trailing_slash(url1: str, url2: str, ignore_trailing_slash: bool, expected_url: str, browser_default_headless: Browser) -> None:
