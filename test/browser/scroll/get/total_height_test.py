...
MARGIN = _helper.tolerance.convert_percent_to_float(50)


@pytest.mark.parametrize("url, expected_total_scroll_height", [
    (internal_url.NOT_SCROLLABLE, 600),
    (internal_url.SCROLL_LONG_VERTICAL, 40802),
])
def test_get_total_scroll_height(url: str, expected_total_scroll_height: int, browser_default_headless_scope_function: Browser) -> None:
