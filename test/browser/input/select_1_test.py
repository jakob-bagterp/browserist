...
from _mock_data.xpath.drop_down_seletor import (DROPDOWN_SELECTOR_OPTION_1_XPATH, DROPDOWN_SELECTOR_OPTION_2_XPATH,
                                                DROPDOWN_SELECTOR_OPTION_3_XPATH, DROPDOWN_SELECTOR_OPTION_4_XPATH)
