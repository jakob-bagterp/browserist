...
@pytest.mark.parametrize("name, expected_handle_id", [
...
def test_window_handle_controller_get_handle_id_by_name(name: str, expected_handle_id: str, window_handle_controller: WindowHandleController) -> None:
