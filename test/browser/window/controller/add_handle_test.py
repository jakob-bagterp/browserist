...
import pytest
from _mock_data.window_handles import (WINDOW_HANDLE_3_ID, WINDOW_HANDLE_3_NAME, WINDOW_HANDLE_4_ID,
                                       WINDOW_HANDLE_4_NAME, WINDOW_HANDLE_5_ID, WINDOW_HANDLE_5_NAME,
                                       WINDOW_HANDLE_6_ID, WINDOW_HANDLE_6_NAME)

from browserist.exception.window_handle import (WindowHandleIdNotUniqueError, WindowHandleIdNotValidError,
                                                WindowHandleNameNotUniqueError)
from browserist.model.window.controller import WindowHandleController


@pytest.mark.parametrize("id, name, expected_handle_count", [
