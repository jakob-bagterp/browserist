...
def test_window_handle_controller_get_handle_name_by_id(
    id: str, expected_handle_name: str, window_handle_controller: WindowHandleController
) -> None:
...
@pytest.mark.parametrize(
    "id, expectation",
    [(WINDOW_HANDLE_1_ID, does_not_raise()), ("Not valid ID", pytest.raises(WindowHandleIdNotFoundError))],
)
@pytest.mark.xdist_group(name="serial_window_tests")
def test_window_handle_controller_get_handle_name_by_id_not_found_error(
