...
def test_wait_until_images_have_loaded_with_specified_xpath(url: str, xpath: str, expectation: Any, browser_default_headless: Browser) -> None:
...
def test_wait_until_images_have_loaded_without_specified_xpath(url: str, expectation: Any, browser_default_headless: Browser) -> None:
    browser = reset_to_not_timed_out(browser_default_headless)
    with expectation:
        browser.open.url(url)
