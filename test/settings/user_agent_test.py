...
@pytest.mark.parametrize("browser_settings, expectation", [
    (BrowserSettings(type=BrowserType.CHROME, headless=True, user_agent="test"), does_not_raise()),
    (BrowserSettings(type=BrowserType.EDGE, headless=True, user_agent="test"), does_not_raise()),
