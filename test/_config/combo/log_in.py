...
LOGIN_FORM_1_STEP_WITH_RETURN_BOOL_AND_POST_LOGIN_URL = deepcopy(LOGIN_FORM_1_STEP_WITH_RETURN_BOOL_AND_BOTH_POST_LOGIN_ATTRIBUTES)
LOGIN_FORM_1_STEP_WITH_RETURN_BOOL_AND_POST_LOGIN_URL.post_login_element_xpath = None

LOGIN_FORM_1_STEP_WITH_RETURN_BOOL_AND_POST_LOGIN_ELEMENT = deepcopy(LOGIN_FORM_1_STEP_WITH_RETURN_BOOL_AND_BOTH_POST_LOGIN_ATTRIBUTES)
...
LOGIN_FORM_2_STEPS_WITH_RETURN_BOOL_AND_POST_LOGIN_URL = deepcopy(LOGIN_FORM_2_STEPS_WITH_RETURN_BOOL_AND_BOTH_POST_LOGIN_ATTRIBUTES)
LOGIN_FORM_2_STEPS_WITH_RETURN_BOOL_AND_POST_LOGIN_URL.post_login_element_xpath = None

LOGIN_FORM_2_STEPS_WITH_RETURN_BOOL_AND_POST_LOGIN_ELEMENT = deepcopy(LOGIN_FORM_2_STEPS_WITH_RETURN_BOOL_AND_BOTH_POST_LOGIN_ATTRIBUTES)
