...
LOGIN_FORM_1_STEP_WITH_RETURN_BOOL = deepcopy(LOGIN_FORM_1_STEP)
LOGIN_FORM_1_STEP_WITH_RETURN_BOOL.return_bool = True
...
LOGIN_FORM_2_STEPS_WITH_RETURN_BOOL = deepcopy(LOGIN_FORM_2_STEPS)
LOGIN_FORM_2_STEPS_WITH_RETURN_BOOL.return_bool = True
